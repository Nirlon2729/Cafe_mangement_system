...
// Fetch all Beverages products from the database
function fetchIceCreams($conn) {
    $stmt = $conn->prepare("SELECT * FROM products WHERE category = 'Beverages'");
    $stmt->execute();
